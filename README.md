...
Phase 0 기획과 Phase 1 기술 스파이크를 거쳐 **Phase 2 최소 실사용 뷰어**를 구현했다. Phase 2.3 I420 제품 cache 통합과 Windows 설치 검증을 완료했고, Phase 3A에서 플랫폼 중립 좌표 기반 Zoom/Pan/Fit/Fullscreen을 통합한다. 결과는 [Phase 3A View Transform](docs/14_PHASE3A_VIEW_TRANSFORM.md)에 기록한다.
