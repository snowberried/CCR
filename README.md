...
Phase 2.3 I420 제품 cache, Phase 3A View Transform과 Phase 3B Video Display를 완료했다. Phase 4A에서는 원본 image pixel 좌표의 프레임별 Arrow/Text/Ellipse/Rectangle 주석, 전역 Undo/Redo와 annotated timeline을 세션 RAM 범위로 통합했다. 상세 내용은 [Phase 4A](docs/17_PHASE4A_FRAME_ANNOTATION.md)에서 확인한다.
