...
Phase 0 기획과 Phase 1 기술 스파이크를 거쳐 **Phase 2 최소 실사용 뷰어**를 구현했다. Phase 2.3 I420 제품 cache와 Phase 3A Zoom/Pan/Fit/Fullscreen을 완료했고, Phase 3B에서 MP4 화면 픽셀 기반 Video Display를 통합했다. 승인 후 추가한 10%p zoom과 PACS식 도구 막대는 [Viewer Controls](docs/16_POST_PHASE3B_VIEWER_CONTROLS.md)에 기록한다.
