...
Phase 0 기획과 Phase 1 기술 스파이크를 거쳐 **Phase 2 최소 실사용 뷰어**를 구현했다. Phase 2.3 I420 제품 cache와 Phase 3A Zoom/Pan/Fit/Fullscreen을 완료했고, Phase 3B에서 MP4 화면 픽셀 기반 Video Display를 통합했다. 결과는 [Phase 3B Video Display](docs/15_PHASE3B_VIDEO_DISPLAY.md)에 기록한다.
