...
1280×720, 3,766-frame 실제 영상의 5프레임 정·역방향 전체 이동에서 체감 정지가 사라졌고 연속 이동 foreground 재디코드는 0이었다. 임의 구간 점프 뒤에도 부드럽게 복귀했으며, 10프레임 이상 간격의 재발 가능성은 v0.5.8 범위 밖으로 남겼다.

v0.5.8은 안정판으로 확정했고 2026-07-15 공개 Latest Release로 배포했다. 자동 Release 사전 검사 복구 후 전체 GitHub Windows test·package·privacy·checksum 검증과 설치파일·checksum·blockmap·`latest.yml` 게시를 완료했다.
