...
class Alpha4RandomSeekBaselineTest {
    ...
    @Test
    fun deterministicPilotRandomSeekAlpha4Baseline() {
        assumeTrue(
            "Alpha 4 random baseline requires Samsung SM-S928*",
    ...
    private fun exerciseFixture(activity: GateActivity, spec: FixtureSpec): JSONObject {
        ...
        assertTrue("cache budget unavailable", diagnostics.cacheBudgetBytes > 0L)
    ...
    private fun writeReport(outcome: Result<Unit>, fixtures: JSONArray) {
        ...
        val report = JSONObject()
            ...
            .put("kind", "alpha4-random-source-equivalent-timing-baseline")
    ...
    companion object {
        const val REPORT_FILE = "s24-alpha4-random-seek-baseline-v1.json"
