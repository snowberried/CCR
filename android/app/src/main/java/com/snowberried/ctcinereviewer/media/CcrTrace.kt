...
internal object CcrTrace {
    ...
    const val REVERSE_REFILL_TRIGGER = "CCR.reverse.refill-trigger"
    const val REVERSE_REFILL_START = "CCR.reverse.refill-start"
    const val REVERSE_REFILL_RESUME = "CCR.reverse.refill-resume"
    const val REVERSE_REFILL_APPEND = "CCR.reverse.refill-append"
    const val REVERSE_REFILL_COMPLETE = "CCR.reverse.refill-complete"
    const val REVERSE_REFILL_CANCEL = "CCR.reverse.refill-cancel"
    const val TEXTURE_COPY = "CCR.texture.copy"
    const val REQUEST_ACCEPT = "CCR.request.accept"
    const val ACTOR_START = "CCR.actor.start"
    const val CACHED_NAVIGATION_START = "CCR.cached-navigation.start"
